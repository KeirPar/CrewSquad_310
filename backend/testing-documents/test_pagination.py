...
def test_pagination_offset_out_of_bounds():
    ...
    assert response.json()["message"] == "No restaurants found matching your search. Try adjuisting your filters or checking for typos." #message now matches in search_service and test_search