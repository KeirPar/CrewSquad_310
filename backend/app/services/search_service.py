...
class SearchService: #make our SearchService class
    ...
    def filter_restaurants(self, name: str = None, cuisine_type: CuisineType = None, min_rating: float = None, sort_by: RestaurantSortOrder = None, limit: int = 10, offset: int = 0):
